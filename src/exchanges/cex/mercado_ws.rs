//! Mercado Bitcoin WebSocket Implementation
//!
...
/// Mercado Bitcoin WebSocket client
pub struct MercadoWs {
...
impl MercadoWs {
    ...
    fn parse_trade(data: &MercadoWsTrade, symbol: &str) -> Trade {
...
mod tests {
    ...
    fn test_process_message() {
        ...
        let msg = r#"{"channel":"ticker","market":"BTC-BRL","data":{"last":"49550"}}"#;
        assert!(MercadoWs::process_message(msg, &tx).is_ok());
    }
}
