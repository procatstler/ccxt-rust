//! Zebpay WebSocket Implementation
//!
...
impl ZebpayWs {
    ...
    fn format_symbol(symbol: &str) -> String {
        // Zebpay uses format like "BTC-INR" for BTC/INR
...
mod tests {
    ...
    fn test_process_message() {
        ...
        let msg = r#"{"type":"ticker","pair":"BTC-INR","data":{"last":"4955000"}}"#;
        assert!(ZebpayWs::process_message(msg, &tx).is_ok());
    }
}
