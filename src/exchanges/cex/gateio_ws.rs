...
//!
//! Alias for Gate WebSocket (same API, different branding)
...
/// Gate.io WebSocket 클라이언트 (GateWs 래퍼)
///
/// Gate.io는 Gate와 동일한 WebSocket API를 사용하는 alias입니다.
pub struct GateioWs(GateWs);
