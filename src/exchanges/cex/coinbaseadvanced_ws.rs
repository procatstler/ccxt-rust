...
mod tests {
    ...
    fn test_with_config() {
        ...
        let _ws = CoinbaseAdvancedWs::with_config(config);
        // Config is set in inner CoinbaseWs
    }
}
