...
impl KrakenFuturesWs {
    ...
    fn parse_order_update(data: &KfWsOrder) -> Option<WsOrderEvent> {
        ...
        let price = data.limit_price.and_then(|v| Decimal::from_f64_retain(v));
        ...
        let order = Order {
            ...
            cost: None,
            trigger_price: data.stop_price.and_then(|v| Decimal::from_f64_retain(v)),
            stop_price: data.stop_price.and_then(|v| Decimal::from_f64_retain(v)),
        ...
        let positions: Vec<Position> = data.positions.as_ref()
            .map(|items| {
                items.iter().filter_map(|item| {
                    ...
                    let contracts = item.balance.and_then(|v| Decimal::from_f64_retain(v))?;
                    ...
                    Some(Position {
                        ...
                        notional: None,
                        leverage: item.effective_leverage.and_then(|v| Decimal::from_f64_retain(v)),
                        unrealized_pnl: item.pnl.and_then(|v| Decimal::from_f64_retain(v)),
                        realized_pnl: None,
                        collateral: None,
                        margin_mode: Some(MarginMode::Cross),
                        entry_price: item.entry_price.and_then(|v| Decimal::from_f64_retain(v)),
                        mark_price: item.mark_price.and_then(|v| Decimal::from_f64_retain(v)),
                        ...
                        stop_loss_price: None,
                        take_profit_price: None,
                        last_price: item.mark_price.and_then(|v| Decimal::from_f64_retain(v)),
                        last_update_timestamp: Some(timestamp),
