//! Binance USDⓈ-M Exchange Implementation
//!
//! Alias for Binance Futures (USDⓈ-M / Linear Futures)
...
/// Binance USDⓈ-M 거래소 (BinanceFutures 래퍼)
///
/// Binance USDⓈ-M은 Binance의 USDT 마진 선물 거래소입니다.
/// - Linear futures (USDT-margined)
/// - API: fapi.binance.com
pub struct BinanceUsdm(BinanceFutures);

impl BinanceUsdm {
    /// 새 Binance USDⓈ-M 인스턴스 생성
    pub fn new(config: ExchangeConfig) -> CcxtResult<Self> {
        Ok(Self(BinanceFutures::new(config)?))
    }
}
